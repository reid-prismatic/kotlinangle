...
//			val lib = DynamicLibraryBundle()
	...
	external fun glBlendFuncSeparate(
		sfactorRGB: Int,
		dfactorRGB: Int,
		sfactorAlpha: Int,
		dfactorAlpha: Int
	...
	external fun glColorMask(red: Byte, green: Byte, blue: Byte, alpha: Byte)
	...
	external fun glCopyTexSubImage2D(
		target: Int,
		level: Int,
		xoffset: Int,
		yoffset: Int,
	...
	external fun glDepthMask(flag: Byte)
	...
	external fun glFramebufferRenderbuffer(
		target: Int,
		attachment: Int,
	...
	external fun glSampleCoverage(value: Float, invert: Byte)
	 ...
	 * @param value a direct or array-backed [java.nio.FloatBuffer]
	 */
	fun glUniformMatrix2fv(location: Int, count: Int, transpose: Byte, value: FloatBuffer?) {
		val value_is_direct: Boolean = Buffers.isDirect(value)
		glUniformMatrix2fv1(
			location,
			count,
	 ...
	 * @param value a direct or array-backed [java.nio.FloatBuffer]
	 */
	fun glUniformMatrix3fv(location: Int, count: Int, transpose: Byte, value: FloatBuffer?) {
		val value_is_direct: Boolean = Buffers.isDirect(value)
		glUniformMatrix3fv1(
			location,
			count,
	 ...
	 * @param value a direct or array-backed [java.nio.FloatBuffer]
	 */
	fun glUniformMatrix4fv(location: Int, count: Int, transpose: Byte, value: FloatBuffer?) {
		val value_is_direct: Boolean = Buffers.isDirect(value)
		glUniformMatrix4fv1(
			location,
			count,
